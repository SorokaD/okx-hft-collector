...
staleness_ms_gauge = Gauge("staleness_ms_gauge", "Event staleness in ms", ["channel","instId"])
event_loop_lag_ms = Gauge("event_loop_lag_ms", "Event loop lag in ms", [])
ws_roundtrip_ms = Summary("ws_roundtrip_ms", "WebSocket ping-pong round-trip time ms", [])
